...
//        environment.put(Context.SECURITY_PRINCIPAL, "CN=,OU=Application-Accounts,OU=,OU=Business-Systems,OU=Enterprise-Applications,DC=,DC=,DC=,DC=");
//        environment.put(Context.SECURITY_CREDENTIALS, "P#$$w0rd123456");
//        try {
